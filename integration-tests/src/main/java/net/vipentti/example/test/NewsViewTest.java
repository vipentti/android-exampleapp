...
package net.vipentti.example.test;

import static net.vipentti.example.core.Constants.Extra.NEWS_ITEM;
import android.content.Intent;
import android.test.ActivityInstrumentationTestCase2;

import net.vipentti.example.core.News;
import net.vipentti.example.ui.CarouselActivity;
...
public class NewsViewTest extends ActivityInstrumentationTestCase2<CarouselActivity> {
    ...
    /**
     * Create test for {@link net.vipentti.example.ui.CarouselActivity}
     */
    public NewsViewTest() {
