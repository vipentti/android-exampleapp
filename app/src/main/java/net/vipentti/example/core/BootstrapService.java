...
public class BootstrapService {
    ...
    public User authenticate(FacebookUtils.PostBody data) {
        return getUserService().authenticate(data);
    }

    public String updateUser(String token, String id, User user) {
        return getUserService().updateUser(token, id, user);
    }
    /*
    public User authenticate(String authData) {
        return getUserService().authenticate(authData);
    }
    */
}