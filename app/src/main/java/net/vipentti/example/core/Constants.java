...
public final class Constants {
    ...
    public static final class Facebook {
        ...
        public static final String NAMESPACE = "YOUR_FACEBOOK_APP_NAMESPACE";
    }
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "net.vipentti.example";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "ExampleApp";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "net.vipentti.example.sync";
    ...
    public static final class Http {
        ...
        public static final String PARAM_AUTHDATA = "authData";

        /**
         * Original Bootstrap Example Api Keys
         */
        /*
        ...
        */
        ...
        public static final String PARSE_APP_ID = "YOUR_PARSE_APP_ID";
        public static final String PARSE_REST_API_KEY = "YOUR_PARSE_REST_API_KEY";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "net.vipentti.example.";
