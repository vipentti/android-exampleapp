...
import static net.vipentti.example.authenticator.BootstrapAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;
...
class BootstrapAccountAuthenticator extends AbstractAccountAuthenticator {
     ...
     * {@link net.vipentti.example.authenticator.ApiKeyProvider#getAuthKey()}
